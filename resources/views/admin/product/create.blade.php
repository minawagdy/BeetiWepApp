...
<div class="intro-y col-span-12 lg:col-span-6 mt-5">
    ...
    <div class="intro-y box">
        <div class="flex flex-col sm:flex-row items-center p-5 border-b border-slate-200/60 dark:border-darkmode-400">
            ...
            <form name="add-blog-post-form" id="add-blog-post-form" method="post" action="{{route('product.store')}}" enctype="multipart/form-data">
        ...
        <div id="vertical-form" class="p-5">
            ...
            <tr>  
                ...
                <td><button type="button" name="add" id="add" class="btn btn-success">Add More</button></td>  
                        ...
                        <div class="mt-3">
                    <label for="vertical-form-2" class="form-label">Images</label>
                    <input id="vertical-form-2" class="form-control" type="file" name="images[]" multiple></input>
                </div>
                @error('images')
                <div class="error">{{ $message }}</div>
                @enderror
